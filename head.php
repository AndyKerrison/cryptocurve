...
<!-- Favicon -->
<link rel="shortcut icon" href="http://localhost/test/img/cryptocurve-favicon.png" type="image/x-icon">
<link rel="icon" href="http://localhost/test/img/cryptocurve-favicon.png" type="image/x-icon">
