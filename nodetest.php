...
var AjaxHelper = (function()
{
	...
	function ajaxGet(path, success, error)
	{
		/*$.ajax({
			type: "GET",
				url: "https://172.31.0.81/api" + path,				
				contentType: "application/json; charset=utf-8",
				crossDomain: true,
				dataType: "json",
				success: success,
	...
	function getSuccess(data)
{
	...
	return {
		...
		testGetBalance: function(owner)
		{
			var data = {};
			data["address"] = owner;
			ajaxPost("getBalance", data, getSuccess, defaultError);
		}
	}
}
)();
...
$( document ).ready(function() {
	...
	alert("calling new get balance");
	AjaxHelper.testGetBalance("0x30fE208CAD112E6Ef4d37115301bd7FfB9fd7203");
